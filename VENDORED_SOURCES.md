...
| `cores-src/mupen64plus_next/` | https://github.com/libretro/mupen64plus-libretro-nx.git | `f275caf4b2bfa1e6d1c51636746ea793f3d80320` (`master`, 2026-08-06) | base commit plus the QNX changes in this root repository | Current GLideN64 rendering base, QNX ARM dynarec/GLES2 port, GCC 8.5/gas-2.19 compatibility, fixed threaded command ring and reduced static memory use |
