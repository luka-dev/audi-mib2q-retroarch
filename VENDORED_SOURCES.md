...
| `cores-src/mupen64plus_next/` | https://github.com/libretro/mupen64plus-libretro-nx.git | `f275caf4b2bfa1e6d1c51636746ea793f3d80320` | base commit plus the QNX changes in this root repository | QNX ARM dynarec/GLES2 port, GCC 4.9 compatibility and reduced static memory use |
