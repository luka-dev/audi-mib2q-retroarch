...
#ifdef HAVE_OZONE
/* Ozone colour theme: stock Audi MMI red palette. */
#define DEFAULT_OZONE_COLOR_THEME OZONE_COLOR_THEME_AUDI_RED
...
#define DEFAULT_MENU_SWAP_OK_CANCEL_BUTTONS_AUTO true
