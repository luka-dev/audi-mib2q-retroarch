...
/* TEMP bring-up: forward-decl the file-based tracer defined later in the unity
 * TU (gfx/drivers_context/qnx_ctx.c) so files included BEFORE it (video_driver.c)
 * can trace which video driver is selected. Remove with the tracer. */
...
============================================================ */
#ifdef HAVE_QSA
#include "../audio/drivers/qnx_qsa.c"
#endif
...
#include "../tasks/task_content_discovery.c"
