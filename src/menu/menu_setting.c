   ...
   if (setting)
   {
      switch (*setting->value.target.unsigned_integer)
      {
         ...
         case OZONE_COLOR_THEME_AUDI_RED:
            return strlcpy(s,
                  msg_hash_to_str(
                     MENU_ENUM_LABEL_VALUE_OZONE_COLOR_THEME_AUDI_RED), len);
         case OZONE_COLOR_THEME_AUDI_NEUTRAL:
            return strlcpy(s,
                  msg_hash_to_str(
                     MENU_ENUM_LABEL_VALUE_OZONE_COLOR_THEME_AUDI_NEUTRAL), len);
         case OZONE_COLOR_THEME_AUDI_AMBER:
            return strlcpy(s,
                  msg_hash_to_str(
                     MENU_ENUM_LABEL_VALUE_OZONE_COLOR_THEME_AUDI_AMBER), len);
         case OZONE_COLOR_THEME_AUDI_BLUE:
            return strlcpy(s,
                  msg_hash_to_str(
                     MENU_ENUM_LABEL_VALUE_OZONE_COLOR_THEME_AUDI_BLUE), len);
         case OZONE_COLOR_THEME_AUDI_GREEN:
            return strlcpy(s,
                  msg_hash_to_str(
                     MENU_ENUM_LABEL_VALUE_OZONE_COLOR_THEME_AUDI_GREEN), len);
