...
#if defined(__QNX__)
/* QNX 6.5 uses a single-thread-owned EGL context. Keep small menu/widget icon
 * decoding and texture upload on the main thread instead of completing an
 * asynchronous image task during the first widget frame. */
