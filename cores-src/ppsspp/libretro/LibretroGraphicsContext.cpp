...
#if PPSSPP_PLATFORM(QNX)
	// The MHI2Q graphics stack is GLES2-only.  Always negotiate the GLES2
	// context below, even if a persisted core option requests Vulkan.
	preferred = RETRO_HW_CONTEXT_DUMMY;
#endif
...
#if !defined(HAVE_LIBNX) && !PPSSPP_PLATFORM(QNX)
