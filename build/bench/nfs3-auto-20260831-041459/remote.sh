...
nohup /mnt/app/root/retroarch/ra.sh -L '/mnt/app/root/retroarch/cores/pcsx_rearmed_libretro.so' '/fs/sda0/retroarch/ps1/Need for Speed III - Hot Pursuit/Need for Speed III - Hot Pursuit.cue' </dev/null    >/tmp/ra_bench_launch.log 2>&1 &
pid=
i=0
while [ $i -lt 30 ]; do
   sleep 1
